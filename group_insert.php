...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST["member-2"]) && !isset($_POST["member-3"]) && !isset($_POST["member-4"])){
       $sql = "INSERT INTO `group_master`(`event_id`, `leader_id`,`team_name`, `member_1`, `member_2`, `is_confirmed`) VALUES ('$event_id','$leader_id','$team_name','$leader_name','$member2',0);";
    ...
    if(isset($_POST["member-2"]) && ($_POST["member-3"]) && !isset($_POST["member-4"])){
       $sql = "INSERT INTO `group_master`(`event_id`, `leader_id`, `team_name`,`member_1`, `member_2`,`member_3`, `is_confirmed`) VALUES ('$event_id','$leader_id','$team_name','$leader_name','$member2','$member3',0);";
       $result2 = mysqli_query($conn,$sql);
       if($result2){
          header("Location: pending.php");
       }
    ...
    if(isset($_POST["member-2"]) && ($_POST["member-3"]) && ($_POST["member-4"]) && !isset($_POST["member-5"])){
       $sql = "INSERT INTO `group_master`(`event_id`, `leader_id`,`team_name`, `member_1`, `member_2`,`member_3`,`member_4`, `is_confirmed`) VALUES ('$event_id','$leader_id','$team_name','$leader_name','$member2','$member3','$member4',0);";
       $result2 = mysqli_query($conn,$sql);
       if($result2){
          header("Location: pending.php");
       }
    ...
    if(isset($_POST["member-2"]) && ($_POST["member-3"]) && ($_POST["member-4"]) && isset($_POST["member-5"]) && !isset($_POST["member-6"])){
       $sql = "INSERT INTO `group_master`(`event_id`, `leader_id`, `team_name`,`member_1`, `member_2`,`member_3`,`member_4`,`member_5` `is_confirmed`) VALUES ('$event_id','$leader_id','$team_name','$leader_name','$member2','$member3','$member4',$member5,0);";
       $result2 = mysqli_query($conn,$sql);
       if($result2){
          header("Location: pending.php");
       }
