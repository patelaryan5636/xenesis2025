    ...
    <div class="main-wrapper">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"><i data-feather="user"></i><span>
                                    Participants</span><span class="menu-arrow"> </a>
                                    <ul>
                                <li><a href="soloevent.php" class="active">Solo Events</a></li>
                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="../assets/img/icons/enable.svg"
                                    alt=""><span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table  datanew">
                                ...
                                <tbody>
                                  <?php 
                                  $sql = "SELECT * FROM `participant_master` WHERE `is_confirmed` = 0";
                                  ...
                                  while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    $price = $row3['participation_price'];
                                    $p_id = encryptId($row['p_id']);
                                  ...
                                  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class='me-3' href='soloregistration.php?id=<?php echo $p_id;?>'>
