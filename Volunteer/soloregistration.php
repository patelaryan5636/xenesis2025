<?php
    ...
    $sql = "SELECT * FROM `participant_master` WHERE `p_id` = $id";
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <form action="acceptsoloevent.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <a href="soloevent.php  " class="btn btn-cancel">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
