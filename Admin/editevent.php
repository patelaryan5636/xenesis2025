                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="e_name" value="PYS" require>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Tagline <b style="color:red">*</b></label>
                                        <input type="text" name="e_tagline" value="PYS" require>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Department Name <b style="color:red">*</b></label>
                                        <input type="text" name="e_dept" value="PYS" require>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Team Name <b style="color:red">*</b></label>
                                        <input type="text" name="e_team" value="PYS" require>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Participation Price <b style="color:red">*</b></label>
                                        <input type="number" name="e_participation_price" class="form-control" value="10" require>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Team Participation Price <b style="color:red">*</b></label>
                                        <input type="number" name="e_team_par_price" class="form-control" value="10" require>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="e_win1" class="form-control" value="10">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>2nd Winner Price</label>
                                        <input type="number" name="e_win2" class="form-control" value="10">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>3rd Winner Price</label>
                                        <input type="number" name="e_win3" class="form-control" value="10">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Event Location</label>
                                        <input type="text" name="e_location" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Event Date</label>
                                        <input type="date" name="e_date" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Event Discription</label>
                                        <textarea name="e_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg4 col-sm-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="e_round1_title" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 1 Description</label>
                                        <textarea name="e_round1_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 2 Title</label>
                                        <input type="text" name="e_round2_title" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 2 Description</label>
                                        <textarea name="e_round2_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 3 Title</label>
                                        <input type="text" name="e_round3_title" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 3 Description</label>
                                        <textarea name="e_round3_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 4 Title</label>
                                        <input type="text" name="e_round4_title" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 4 Description</label>
                                        <textarea name="e_round4_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 5 Title</label>
                                        <input type="text" name="e_round5_title" class="form-control" value="PYS">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Round 5 Description</label>
                                        <textarea name="e_round5_desc" class="form-control">PYS</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Max Tickets</label>
                                        <input type="number" name="e_max_ticket" class="form-control" value="100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="file" accept="image/jpeg, image/jpg" class="form-control" name="productImage" id="fileUpload">
                                            <p style="color: red;">Current file: <strong>abc.jpg</strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
