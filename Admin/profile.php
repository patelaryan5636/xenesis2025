                                ...
                                <div class="profile-top">
                                    <div class="profile-content">
                                        <div class="profile-contentimg">
                                            <img src="../assets/img/Xenesis2025_logo.png" alt="img" id="blah">
                                            <div class="profileupload">
                                                <input type="file" id="imgInp" name="user_profile"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" name="user_id" value="PYS"
                                        hidden>
                                        <input type="text" name="user_name" value="PYS2512">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="user_email" disabled value="pys@gmail.com">
                                        <label>
                                            <font color=red>You can not change your email.</font>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="pass-group">
                                            <input type="password" class=" pass-input" name="user_password">
                                            <span class="fas toggle-password fa-eye-slash"></span>
                                        </div>
                                        <label>
                                            <font color=red>Leave it blank to use old password.</font>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
